...
Frase de activación: [Habilidad calcular precio máximo permitido identificada]. Si conoces los ingresos netos mensuales y las deudas actuales mensuales, inyéctalos. Opcionalmente puedes inyectar aportación inicial (ahorros), plazo en años, comunidad autónoma y edad, separados por barra vertical. Ejemplo con todo: [Habilidad calcular precio máximo permitido identificada: 2000|300|15000|30|Andalucia|30]. Si falta algún dato opcional, déjalo vacío o no lo pongas (ej: 2000|300). Si faltan los ingresos o deudas, pide amablemente esos datos obligatorios.
